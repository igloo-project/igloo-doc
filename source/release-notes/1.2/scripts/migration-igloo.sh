...
s@projects\.openwide\.fr/services/nexus/content/repositories/igloo-snapshots@nexus.tools.kobalt-si.fr/repository/igloo-snapshots/@g
s@projects\.openwide\.fr/services/nexus/content/repositories/igloo@nexus.tools.kobalt-si.fr/repository/igloo/@g
EOF
